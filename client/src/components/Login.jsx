...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        <div
          className="relative bg-[#0a0a0a] rounded-2xl p-10 md:p-14 shadow-2xl border border-gray-800 transform transition-transform duration-300 hover:rotate-x-6 hover:rotate-y-6 hover:scale-105 hover:shadow-[0_35px_60px_-15px_rgba(59,130,246,0.5)] group"
          style={{
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold py-5 px-8 rounded-full text-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/50 transform hover:scale-105 z-10 relative"
          >
